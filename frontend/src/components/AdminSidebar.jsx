...
const AdminSidebar = ({ collapsed, setCollapsed, sidebarItems }) => {
  return (
    <aside
      className={`${
        collapsed ? "w-20 " : "w-50"
    ...
    >
      ...
      <div className="flex items-center gap-3 p-5 border-b border-gray-200">
        <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center">
          <Building2 className="w-9 h-5 text-white" />
        </div>
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <button className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-800 mt-4">
          <LogOut size={16} />
